...
3. Use `docs/index/GDD_SOURCE_INDEX.md` for broad keyword discovery and to find the smallest relevant source files.
4. Open files in `docs/game_design_document/` after narrowing the question to a section or topic.
