...
- `docs/curated/03_world_simulation_guide/`: curated world simulation material, including physical-law system bridges that connect raw GDD source to implementation contracts without rewriting raw exports.
