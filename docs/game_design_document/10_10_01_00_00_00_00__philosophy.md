...
- Use **spatial placement**: e.g. health/status bars can exist subtly in the environment (like on the player’s arm), not as HUD overlays.
- Implement **smooth context changes**: teleport between areas without loading screens—fade views, shape transitions, sound cues.
