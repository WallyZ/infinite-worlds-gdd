...
- Reputation exists on multiple layers:
    - **Personal** (individual NPC relationships)
    - **Local** (towns, communities)
    - **Factional** (guilds, kingdoms)
- Players can **influence, manipulate, or repair** reputations through:
    - Deeds, words, bribes, diplomacy, disguises, or social skills.
